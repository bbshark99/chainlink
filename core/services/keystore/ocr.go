...
// 	}
// 	decryptedOCRKey, err := encryptedOCRKey.Decrypt(ks.password)
// 	if err != nil {
// 		return emptyExport, errors.Wrap(err, "unable to decrypt ocr key with given keystore password")
// 	}
// 	encryptedExport, err := decryptedOCRKey.ToEncryptedExport(newPassword, utils.DefaultScryptParams)
// 	if err != nil {
// 		return emptyExport, errors.Wrap(err, "unable to encrypt ocr key for export with provided password")
// 	}
