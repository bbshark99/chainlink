...
type ConfigSchema struct {
	...
	OCR2P2PNetworkingStack                  ocrnetworking.NetworkingStack `env:"OCR2_P2P_NETWORKING_STACK" default:"V1"`
	...
	OCR2P2PV2DeltaDial                      models.Duration               `env:"OCR2_P2PV2_DELTA_DIAL" default:"15s"`
	OCR2P2PV2DeltaReconcile                 models.Duration               `env:"OCR2_P2PV2_DELTA_RECONCILE" default:"1m"`
